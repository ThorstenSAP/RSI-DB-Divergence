...
def getDoubleBottoms(yfResponse, ticker, worksheet, worksheetRow):
    ...
    while index < amntData: 
        ...
        while daysAhead <= 2:
            if not (index + daysAhead > amntData): #safety check for out of index
            ...
            #Current days / last two days
            elif (index < amntData):
                if(yfResponse._values[index + 1][closeIndex] < yfResponse._values[index][closeIndex]):
                    bLowerLow = True
                    break
    ...
    while firstIndex <= amntLows - 2:
        ...
        while secondIndex <= amntLows - 1:
            ...
            if (0.98 < yfResponse._values[firstLowIndex][closeIndex] / yfResponse._values[secondLowIndex][closeIndex] and yfResponse._values[firstLowIndex][closeIndex] / yfResponse._values[secondLowIndex][closeIndex] < 1.02 and 
                ...
                if(daysBetween(yfResponse.index.date[secondLowIndex], datetime.today().date()) <= 6):
...
workbook = xlsxwriter.Workbook('DoubleBottomTest.xlsx')
